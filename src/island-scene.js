...
export class IslandScenery extends Scenery {
  ...
  buildLandmarks() {
    ...
    // harbour road that now runs down from the town's south street.
    ...
    // Town gate: a warm stucco arch where the coast road enters the old town.
